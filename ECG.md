...
>
> <img src="ECG.assets/image-20210408230344319.png" alt="image-20210408230344319" style="zoom:40%;" />
...
>
> <img src="ECG.assets/ch4-18.png" alt="上室性期外収縮の心電図⑤（変行伝導）" style="zoom:67%;" />
...
>
> <img src="ECG.assets/image-20210408221025451.png" alt="image-20210408221025451" style="zoom:15%;" />
>
...
<img src="ECG.assets/image-20210113214725360.png" alt="image-20210113214725360" style="zoom: 33%;" />
...
<img src="ECG.assets/image-20210331100233223.png" alt="image-20210331100233223" style="zoom:67%;" />
...
以上より、R 波増高不良はこれのみでは正常のことが多いが，時には前壁中隔梗塞が隠れていることもあると理解し，また，他の異常も存在するとき前述の諸疾患も鑑別するのがよい。
 ...
 <img src="ECG.assets/poor r progression 1.jpg" alt="poor r progression 1" style="zoom:35%;" />
...
>
> <img src="ECG.assets/reverse r progression 1.jpg" alt="reverse r progression 1" style="zoom:33%;" />
...
後天性の場合、治療は原因の除去であり、薬剤性の場合は原因薬剤の中止が原則である。また硫酸マグネシウムの静注やペーシング治療、イソプロテレノールの使用にて心拍を上昇させること、血清カリウム値を高め（4.5～5mmol/L）に補正することが有効な場合もある。徐脈依存性の場合は心拍数を増加させ、早急に徐脈を改善させることが必要であり、ペースメーカー植え込み術が適応となることが多い。徐脈依存性に伴うTdPはペースメーカー治療により予防されるため、通常、植え込み型除細動器（ICD）は選択されない。
...
刺激伝導系が正常であるにもかかわらず、PP間隔が0.16秒以上の変動を示す洞調律のこと。
洞不整脈は呼吸の周期によって洞周期が変動する呼吸性と、呼吸周期に関係しない非呼吸性に分かれる。
...
房室ブロックなどで心室収縮に伴う心拍出があると、頸動脈洞、大動脈圧受容体からの反射で迷走神経興奮が起こり、その後のRを挟まないPP間隔が延長すると考えられている。
...
![image-20210331234408507](ECG.assets/image-20210331234408507.png)
...
心房と心室にリードがあり、心房の興奮を監視し、心房興奮があった場合にはそれに併せて心室に刺激を送って、心室に自己波を感知した場合には機器からの刺激は送らない、というように抑制と動悸の両方を行う場合には「D：dual」と表記する。
...
合併奇形がない例は、血行動態は修正されているため長期生存が可能である。しかし、左側房室弁は三尖弁であるため、加齢とともに房室弁逆流が生じ臨床上の問題となる。
P波では左側房室弁逆流がある例で左房負荷所見が、右側心室圧が高い例では右房負荷所見が見られる。左右の心室が転換しているためQRSの初期脱分極ベクトルが正常と逆になる。このためV5,V6でqがなく、V1にqが見られる。V1のqは症例により見られないことがある。
本症の刺激伝導系は特殊な走行をしており、40〜70%に房室ブロックが出現する。

<img src="ECG.assets/image-20210405235432562.png" alt="image-20210405235432562" style="zoom:67%;" />
...
SAHに引き続いて様々な心電図変化が生じることが知られている。

頻度の高いものは、ST低下、QT延長、T波の陰転化(deep symmetric T wave inversion)、U波の出現など。
これらの心電図変化はいずれも心筋の虚血を反映したものであり、頭蓋内出血により交感神経が過剰になり、相対的な心筋の虚血が引き起こされると考えられている。

また、SAHではCK-MBやトロポニンも上昇することがあり心疾患との鑑別が重要になる。いずれにしても心電図のみで診断するのではなく、病歴聴取やエコー、CTなど他の検査が重要。

![image-20220620214443251](ECG.assets/image-20220620214443251.png)

## ダブルカウント

心拍数を2回カウントしてしまっている状態。心電図モニターはその波形上の一番高い山を一回の心拍として捉えるため、QRS波とT波の高さがあまり変わらないような場合には心拍数を2回カウントしてしまうことがある。

<img src="ECG.assets/image-20230101183047828.png" alt="image-20230101183047828" style="zoom:60%;" />

原因としては、

* 高カリウム血症などの影響によりT波が高くなる
* 心電図波形が低振幅のためQRS波とT波の高さがほぼ同じになる

などが挙げられる。

通常はモニターにII誘導を表示しているが、ダブルカウントしている場合にはモニタリングするのに適した波形の誘導に設定を変えることが必要。
