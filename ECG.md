...
また、左主幹部の心筋梗塞では、上記以外に下壁誘導(II, III, aVF)の著明なST低下、aVL誘導のST上昇や左軸偏位を伴った右脚ブロックなどの心電図変化が見られることもある。
...
> 4つのタイプに分けられ、Type1は側壁誘導によみJ波が見られるもので、比較的若いスポーツ選手に多く、致死性不整脈のリスクは低い。Type2は下壁または下側壁誘導にJ波が見られ、致死性不整脈のリスクは中等度。Type3は下壁、側壁と左前胸部の全ての誘導に広範囲にJ波が見られるハイリスク群とし、Type1からType3の順で危険性が増すとされる。
> Type4はBrugada症候群を指す。
